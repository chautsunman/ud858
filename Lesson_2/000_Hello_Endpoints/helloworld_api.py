...
GREET_REQUEST_CONTAINER = endpoints.ResourceContainer(
    name=messages.StringField(1),
...
class HelloWorldApi(remote.Service):
    ...
    @endpoints.method(GREET_REQUEST_CONTAINER, Hello, path="greetByPeriod", http_method="GET", name="greetByPeriod")
